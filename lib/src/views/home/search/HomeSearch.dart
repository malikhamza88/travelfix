...
import 'package:TravelFix/src/providers/request_services/Api+search.dart';
import 'package:TravelFix/src/views/home/search/SearchResultCell.dart';
    ...
    return ApiSearch.searchPlaces(text).then((response) {
      _searchPlaces = List<Place>.generate(
        ...
        (i) {
          ...
          p.cityName = widget.cities.firstWhere((c) {return c.id == p.cities.first;}).name;
          return p;
        });
        setState(() {
        });
