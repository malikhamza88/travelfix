...
import 'package:TravelFix/src/providers/request_services/Api+city.dart';
import 'package:TravelFix/src/providers/request_services/PlaceProvider.dart';
import 'package:TravelFix/src/providers/request_services/Api+post.dart';
import 'package:TravelFix/src/providers/request_services/query/PageQuery.dart';
import 'package:TravelFix/src/views/main/DashboardTabs.dart';
...
class _SplashPageState extends State<SplashPage> {
  ...
  void didChangeDependencies() {
    ...
    precacheImage(new AssetImage('assets/photos/splash.jpg'), context);
  }
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/photos/splash.jpg"),
            fit: BoxFit.cover,
          ),
        ),
      )
